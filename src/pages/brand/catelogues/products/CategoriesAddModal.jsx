...
import { addCatalogues, updateCatalogues } from '../../../../middlewares/productCatalogue'
import ToastService from "../../../../helpers/toast-services";
import { titleSchema } from '../../../../helpers/yup.validation.schema'
import { resetForm, resetFormUpdate } from '../../../../slices/productCatalogue.slice'
...
const CategoriesAddModal = (props) => {
  ...
  const { saveLoading, saveMessage, singleCategory,
    saveUpdateLoading, saveUpdateMessage, languages } = useSelector((state) => state.product)
  ...
  const handleSubmit = (values) => {
    ...
    if (singleCategory && singleCategory !== null && singleCategory._id) {
      ...
      const payload = { catalogue: newValues }
      dispatch(addCatalogues(payload, brand_id))
    }
  }
  ...
  const changeLan = props.languages && props.languages.find((obj) => {
